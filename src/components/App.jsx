...
setFeedback(prevFeedback => ({ ...prevFeedback, [feedbackOption]: prevFeedback[feedbackOption] + 1 }));
};
...
<FeedbackOptions options={Object.keys(feedback)} onFeedback={handleFeedback} />
</Section>
